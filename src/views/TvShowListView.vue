<template>
    <div class="container">
        <div class="text-white size-12 size-md-18 weight-800 mrtb-md-8 mrtb-4">Shows</div>
        <div class="row">
            <template v-if="tvShowList.length > 0">
                <div class="col-6 col-md-4 col-lg-4 col-xl-3 mrb-20" v-for="tvShow in tvShowList" :key="tvShow.id">
